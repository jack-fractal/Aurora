...
/mob/living/carbon/alien/larva/proc/handle_breath(var/datum/gas_mixture/breath)
...
/mob/living/carbon/alien/larva/proc/queen_locator()
	if(locate_queen)
...
/mob/living/carbon/alien/larva/proc/handle_stomach()
	spawn(0)
